export default function DealCard({ deal, onViewMore }) {
  return (
    <article className="group flex h-full flex-col rounded-2xl border-[3px] border-[#A20202] bg-white p-5 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_10px_28px_rgba(162,2,2,0.12)] sm:p-6">
      ...
      <p className="mb-1.5 text-center text-[11px] font-semibold uppercase tracking-[0.18em] text-[#A20202]/80 sm:text-xs">
        {deal.startupName}
      </p>
      ...
      <p className="mb-6 flex-1 text-center text-[13px] leading-relaxed text-[#5b6b7c] line-clamp-3 sm:text-[14px]">
